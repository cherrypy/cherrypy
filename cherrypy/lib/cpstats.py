...
class ByteCountWrapper(object):
    ...
    def __init__(self, rfile):
        """Initialize ByteCountWrapper."""
        self.rfile = rfile
        self.bytes_read = 0

    def read(self, size=-1):
        """Read method for ByteCountWrapper."""
        data = self.rfile.read(size)
        self.bytes_read += len(data)
        return data

    def readline(self, size=-1):
        """Readline method for ByteCountWrapper."""
    ...
    def close(self):
        """Close method for ByteCountWrapper."""
        self.rfile.close()

    def __iter__(self):
        """Iterate method for ByteCountWrapper."""
        return self

    def next(self):
        """Next method for ByteCountWrapper."""
...
class StatsTool(cherrypy.Tool):
    ...
    def __init__(self):
        """Initialize StatsTool."""
        cherrypy.Tool.__init__(self, 'on_end_request', self.record_stop)

    def _setup(self):
        """Set Hook for this tool into cherrypy.request.
...
def locale_date(v):
    """Return date formated for locale."""
    return time.strftime('%c', time.gmtime(v))


def iso_format(v):
    """Return date formated ISO."""
    return time.strftime('%Y-%m-%d %H:%M:%S', time.gmtime(v))


def pause_resume(ns):
    """Return pause and return forms."""
