...
application is found at :attr:`app.log<cherrypy.lib.tree.Application.log>`.
...
:func:`tree.mount()<cherrypy.lib.tree.Tree.mount>` or, if you used
...
class LogManager(object):
    ...
    def access(self):
        ...
        :class:`cherrypy.request<cherrypy.lib.request.Request>`.
    ...
    def wsgi(self):
        ...
        :class:`WSGIErrorHandler<cherrypy.lib.logger.WSGIErrorHandler>` for you
