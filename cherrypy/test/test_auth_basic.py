...
class BasicAuthTest(helper.CPWebCase):
    ...
    def testBasic(self):
        ...
        self.assertHeader(
            "WWW-Authenticate", 'Basic realm="wonderland", charset="UTF-8"'
        )
    ...
    def testBasic2_u(self):
        ...
        self.getPage(
            "/basic2_u/", [("Authorization", "Basic eNGO0LfQtdGAOtGX0LbRgw==")]
        )
        self.assertStatus(401)

        self.getPage(
            "/basic2_u/", [("Authorization", "Basic eNGO0LfQtdGAOtGX0LbQsA==")]
        )
        self.assertStatus("200 OK")
